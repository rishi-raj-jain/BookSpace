  ...
  return (
    ...
    Object.keys(spaceData).length >= 1 && (
      <div className="mx-auto mt-12 flex max-w-7xl flex-col px-4">
        <div className="flex flex-col space-y-5 md:flex-row md:space-x-2 md:space-y-0">
          ...
          <div className="p-5 md:w-1/2">
            ...
            <button className={`rounded border p-5 focus:outline-none ${spaceData.ifDirect ? 'text-sky-600' : 'text-red-700'} mb-2 mr-2 mt-3 py-2.5 text-sm font-medium`}>
        ...
        <div className="mt-10">
          ...
          >
            ...
            <button
              type="submit"
              className="mt-3 inline-flex w-36 items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-sky-600 px-4 py-2 text-base text-white shadow-sm hover:bg-sky-700 dark:border-white"
            >
              Book &rarr;
            </button>
          </form>
